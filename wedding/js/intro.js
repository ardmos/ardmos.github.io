...
const WeddingIntro = (() => {
   ...
   * 이미지가 없으면 자동으로 이모지로 대체됩니다. big=true면 3배 크게 표시.
   */
  ...
  function setupBoraEasterEgg(){
    ...
    bora.addEventListener('click', () => {
      ...
      foundMsg.style.top = (localY - 30) + 'px';
  ...
  function setupCoupleHeartTap(){
    ...
    ['groom', 'bride'].forEach((who) => {
      ...
      el.addEventListener('click', () => {
        ...
        spawnParticle(particleLayer, localX, localY, type, Math.random() * 20 - 10, -(60 + Math.random() * 20), 0, true);
      });
    });
  }
